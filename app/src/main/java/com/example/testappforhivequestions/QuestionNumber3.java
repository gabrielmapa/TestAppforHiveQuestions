...
public class QuestionNumber3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_question_number3);
    ...
    private void doValidate() {
        ...
        if(editText.getText().toString().equals(textAnswer)) {
            Toast.makeText(QuestionNumber3.this, "Tama! Ang sagot ay bacolod!", Toast.LENGTH_SHORT).show();
        } else {
            Toast.makeText(QuestionNumber3.this, "Mali! Subukan muli!", Toast.LENGTH_SHORT).show();
            editText.setText("");
        }
        keys = shuffleArray(keys);
